...
$.formValidator =
{
	...
	//设置正确的显示信息
	setCorrectState : function(tipID,showmsg) {
		$.formValidator.setTipState($("#"+tipID).get(0), "onCorrect", showmsg);
	},

	//设置正确的显示信息
	setShowState : function(tipID,showmsg) {
		$.formValidator.setTipState($("#"+tipID).get(0), "onShow", showmsg);
	},

	//设置正确的显示信息
	setFocusState : function(tipID,showmsg) {
		$.formValidator.setTipState($("#"+tipID).get(0), "onFocus", showmsg);
	},
	...
	showAjaxMessage : function(returnObj)
	{
		...
		else if($("#"+returnObj.id).data("reValid"))
		{
			$.formValidator.ajaxValid(returnObj);
			$("#"+returnObj.id).data("reValid",false);
		}
		else
		{
	...
	serialize : function(objs)
	{
		...
		$.each(parmArray,function(index,data){
			...
			//TDO 解决ajax传中文到后台为空 去掉 escape处理 	var value = escape(decodeURIComponent(data.substr(li_pos+1)));
	...
	return this.each(function(e)
	{
		...
		if(srcTag == "input" || srcTag=="textarea")
		{
			...
			jqobj.bind(setting.triggerEvent, function(){
				...
				if(settings[0].isTrim){this.value = $.trim(this.value);}
				//进行有效性校验
